...
int main(int argc, char* argv[]) {
    ...
    // Adding Game Objects
    // Player1
    auto* player1_renderer = new Renderer("../data/img/player.jpg", game_renderer->get_main_renderer());
    ...
    // Player2
    auto* player2_renderer = new Renderer("../data/img/player.jpg",  game_renderer->get_main_renderer());
    ...
    // ball
    auto* ball_renderer = new Renderer("../data/img/ball.jpg",  game_renderer->get_main_renderer());
    auto* ball_collider = new Collider();
    auto* ball = new GameObject(2, Vector2(BALL_WIDTH, BALL_HEIGHT), Vector2(WINDOW_WIDTH/2,WINDOW_HEIGHT/2));
